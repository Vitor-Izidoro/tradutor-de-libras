...
**`predicoes_modelo_1.txt`** — Predições do Random Forest para os vídeos de teste, uma por linha, na ordem de processamento. Gerado pela opção `[3]`.

**`predicoes_modelo_2.txt`** — Predições do LSTM para os vídeos de teste.

**`predicoes_modelo_3.txt`** — Predições do KNN para os vídeos de teste.
...
**`gabarito.txt`** — Rótulos reais dos vídeos de teste, usados como referência para a matriz de confusão.
